      ...
      <div className="p-4 rounded-3xl bg-surface border border-border flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 shadow-sm shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            {showVoiceMenu && (
              <div className="absolute right-0 mt-2 w-80 max-h-96 bg-surface border border-border rounded-2xl shadow-2xl p-3 z-50 flex flex-col space-y-2">
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 text-xs bg-surfaceSecondary border border-border rounded-xl text-text focus:outline-none focus:border-primary"
                />
                ...
                <div className="flex items-center gap-1 overflow-x-auto pb-1 no-scrollbar shrink-0">
                  {['all', 'popular', 'calm', 'energetic', 'deep', 'celestial'].map((cat) => (
                    <button
                      ...
                      className={`px-2.5 py-0.5 rounded-lg text-[10px] font-medium capitalize shrink-0 transition-colors ${
                        voiceCategory === cat
                    ...
                    >
                      <div className="truncate pr-2">
                        <div className="flex items-center gap-1.5">
                          <span className="font-semibold text-xs">{vp.name}</span>
                      ...
                      {selectedVoicePersona === vp.id && <CheckIcon className="w-4 h-4 text-primary shrink-0" />}
                    </button>
                  ))}
                </div>
              </div>
