    ...
    <div className="space-y-6 pb-12 animate-in fade-in duration-200 max-w-4xl mx-auto">
      ...
      <div className="p-6 rounded-3xl bg-gray-900/80 border border-white/10 backdrop-blur-md">
        <div className="flex items-center gap-2 text-xs font-semibold text-indigo-400 mb-1">
          ...
          <span>Saarathi OS Preferences & Architecture</span>
        </div>
        ...
        <>
          ...
          <div className="p-6 rounded-3xl bg-gray-900/80 border border-white/10 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-gray-400 block mb-1">Start of Working Hours</label>
                <input
                  type="time"
                  value={workingStart}
                  onChange={(e) => setWorkingStart(e.target.value)}
                  className="w-full bg-gray-950 border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-indigo-500"
                />
              </div>

              <div>
                <label className="text-xs text-gray-400 block mb-1">End of Working Hours</label>
                <input
                  type="time"
                  value={workingEnd}
            ...
            <div className="pt-2 border-t border-white/5 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs font-bold text-white">Auto-Reschedule High Risk Tasks</div>
                  <div className="text-[11px] text-gray-400">
                    Automatically propose optimal rescheduling slots when fatigue or procrastination probability exceeds 75%.
                  </div>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs font-bold text-white">Smart Proactive Notifications</div>
                  <div className="text-[11px] text-gray-400">
                    Receive context-aware push notifications before predicted low-energy slumps.
                  </div>
                </div>
                <input
                  type="checkbox"
        ...
        <div className="p-6 rounded-3xl bg-gray-900/80 border border-white/10 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-white flex items-center gap-2">
              ...
              <span>Saarathi Express & FastAPI Gateway Diagnostics</span>
            </h3>
