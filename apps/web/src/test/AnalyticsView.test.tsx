...
describe('AnalyticsView Component Render & Interactions', () => {
  it('should render the Productivity Analytics header and key overview metric cards', async () => {
    await act(async () => {
  ...
  it('should allow toggling between Today, 7 Days, and 30 Days time ranges', async () => {
  ...
  it('should render the 7x24 Day x Hour heatmap section', async () => {
    await act(async () => {
      render(<AnalyticsView analytics={initialAnalytics} />);
    });
  ...
  it('should render energy correlation and Kairo interaction insights', async () => {
    await act(async () => {
      render(<AnalyticsView analytics={initialAnalytics} />);
    });
